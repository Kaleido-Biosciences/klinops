...
import { BioAnalysisComponent } from 'app/entities/bio-analysis/bio-analysis.component';
...
describe('Component Tests', () => {
  describe('BioAnalysis Management Component', () => {
    let comp: BioAnalysisComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BioAnalysisComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bioAnalyses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
