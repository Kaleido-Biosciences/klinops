...
import { KoHealthCheckComponent } from 'app/admin/health/health.component';
import { KoHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('KoHealthCheckComponent', () => {
    let comp: KoHealthCheckComponent;
    let fixture: ComponentFixture<KoHealthCheckComponent>;
    let service: KoHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [KlinopsTestModule],
        declarations: [KoHealthCheckComponent]
      })
        .overrideTemplate(KoHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(KoHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(KoHealthService);
    });
