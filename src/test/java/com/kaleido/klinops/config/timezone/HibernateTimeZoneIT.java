...
package com.kaleido.klinops.config.timezone;

import com.kaleido.klinops.KlinopsApp;
import com.kaleido.klinops.config.TestSecurityConfiguration;
import com.kaleido.klinops.repository.timezone.DateTimeWrapper;
import com.kaleido.klinops.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ko_date_time_wrapper where id=%d", fieldName, id);
    }
