...
export class LaboratoryService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/laboratories';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ILaboratory[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
