...
export class PrincipalInvestigatorService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/principal-investigators';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPrincipalInvestigator[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
